...
public class StudentApp {
	...
	public static void main(String[] args) {
		...
		Location location3 = new Location("Meisenstr. 92", 33607, "Bielefeld");
		Student student3 = new Student("Moritz Fleißig", location3, location3);
		System.out.println(student3);
		System.out.println(student3.getPlaceOfBirth() == student3.getResidence());
		
		//Beispiel für die Nutzung des Aufzählungstypen Degree
